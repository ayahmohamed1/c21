...
export default function EnvelopeOpen({ config, onContinue }) {
  ...
  return (
    <motion.section
      ...
      className="relative flex flex-col items-center justify-center min-h-screen px-6 text-center overflow-hidden bg-cream"
    >
